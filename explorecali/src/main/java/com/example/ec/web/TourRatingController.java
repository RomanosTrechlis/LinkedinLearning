...
public class TourRatingController {
  ...
  public Page<RatingDto> getAllRatingsForTour(@PathVariable(value = "tourId") int tourId,
    ...
    List<RatingDto> ratingDtoList = tourRatingPage
        .getContent()
        .stream()
  ...
  public AbstractMap.SimpleEntry<String, Double> getAverage(@PathVariable(value = "tourId") int tourId) {
    ...
    OptionalDouble average = tourRatings
        .stream()
        .mapToInt(TourRating::getScore)
        .average();
    return new AbstractMap.SimpleEntry<String, Double>("average", average.isPresent()
        ? average.getAsDouble()
        : null);
  }
